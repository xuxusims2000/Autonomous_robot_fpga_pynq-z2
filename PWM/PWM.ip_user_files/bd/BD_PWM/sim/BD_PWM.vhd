...
--Date        : Mon Apr  8 17:10:55 2024
--Host        : DESKTOP-T6T718M running 64-bit major release  (build 9200)
--Command     : generate_target BD_PWM.bd
--Design      : BD_PWM
...
entity BD_PWM is
  ...
  attribute CORE_GENERATION_INFO of BD_PWM : entity is "BD_PWM,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BD_PWM,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=4,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of BD_PWM : entity is "BD_PWM.hwdef";
end BD_PWM;

architecture STRUCTURE of BD_PWM is
  component BD_PWM_processing_system7_0_0 is
  port (
  ...
  end component BD_PWM_processing_system7_0_0;
  component BD_PWM_PWM_generator_0_1 is
  port (
    clk : in STD_LOGIC;
  ...
  end component BD_PWM_PWM_generator_0_1;
...
begin
  ar0 <= PWM_generator_0_PWM_out;
  btn0_1 <= btn0;
  btn1_1 <= btn1;
PWM_generator_0: component BD_PWM_PWM_generator_0_1
     port map (
...
processing_system7_0: component BD_PWM_processing_system7_0_0
     port map (
