...
--               c:/Users/Usuario/Desktop/distancia_leds/distancia_leds/distancia_leds.gen/sources_1/bd/bs_distane_leds/ip/bs_distane_leds_HCRS04_0_0/bs_distane_leds_HCRS04_0_0_sim_netlist.vhdl
...
entity bs_distane_leds_HCRS04_0_0_TriggerGen is
  port (
    CO : out STD_LOGIC_VECTOR ( 0 to 0 );
    clk : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of bs_distane_leds_HCRS04_0_0_TriggerGen : entity is "TriggerGen";
end bs_distane_leds_HCRS04_0_0_TriggerGen;

architecture STRUCTURE of bs_distane_leds_HCRS04_0_0_TriggerGen is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bs_distane_leds_HCRS04_0_0_distance_calculation is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of bs_distane_leds_HCRS04_0_0_distance_calculation : entity is "distance_calculation";
end bs_distane_leds_HCRS04_0_0_distance_calculation;

architecture STRUCTURE of bs_distane_leds_HCRS04_0_0_distance_calculation is
  signal gtOp1_in : STD_LOGIC;
  signal gtOp4_in : STD_LOGIC;
  signal \gtOp__8\ : STD_LOGIC;
  ...
  signal \NLW_gtOp_inferred__0/i__carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  signal \NLW_gtOp_inferred__1/i__carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  signal \NLW_ltOp_inferred__2/i__carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \leds[3]_INST_0_i_1\ : label is "soft_lutpair1";
  attribute COMPARATOR_THRESHOLD of \ltOp_inferred__0/i__carry\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \ltOp_inferred__0/i__carry__0\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \ltOp_inferred__0/i__carry__1\ : label is 11;
...
\gtOp_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 1) => B"000",
      S(0) => \gtOp_carry__1_i_1_n_0\
    );
\gtOp_carry__1_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\gtOp_inferred__0/i__carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_gtOp_inferred__0/i__carry__1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => gtOp1_in,
...
\gtOp_inferred__1/i__carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_gtOp_inferred__1/i__carry__1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => gtOp4_in,
...
\ltOp_inferred__2/i__carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_ltOp_inferred__2/i__carry__1_CO_UNCONNECTED\(3),
      CO(2) => ltOp,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bs_distane_leds_HCRS04_0_0_time_counter is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of bs_distane_leds_HCRS04_0_0_time_counter : entity is "time_counter";
end bs_distane_leds_HCRS04_0_0_time_counter;

architecture STRUCTURE of bs_distane_leds_HCRS04_0_0_time_counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bs_distane_leds_HCRS04_0_0_HCRS04 is
  port (
    leds : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of bs_distane_leds_HCRS04_0_0_HCRS04 : entity is "HCRS04";
end bs_distane_leds_HCRS04_0_0_HCRS04;

architecture STRUCTURE of bs_distane_leds_HCRS04_0_0_HCRS04 is
...
begin
  Trigger <= \^trigger\;
Inst_TriggerGen: entity work.bs_distane_leds_HCRS04_0_0_TriggerGen
     port map (
      CO(0) => \^trigger\,
      clk => clk
    );
Inst_counter: entity work.bs_distane_leds_HCRS04_0_0_time_counter
     port map (
      CO(0) => \^trigger\,
...
Inst_distance_calculation: entity work.bs_distane_leds_HCRS04_0_0_distance_calculation
     port map (
      CO(0) => \leds[3]_INST_0_i_2_n_1\,
...
\leds[3]_INST_0_i_10\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\leds[3]_INST_0_i_22\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\leds[3]_INST_0_i_23\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\leds[3]_INST_0_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \leds[3]_INST_0_i_10_n_0\,
      DI(2) => \leds[3]_INST_0_i_11_n_0\,
      DI(1) => \leds[3]_INST_0_i_12_n_0\,
      DI(0) => '0',
      O(3 downto 0) => \NLW_leds[3]_INST_0_i_3_O_UNCONNECTED\(3 downto 0),
      S(3) => \leds[3]_INST_0_i_13_n_0\,
      S(2) => \leds[3]_INST_0_i_14_n_0\,
      S(1) => \leds[3]_INST_0_i_15_n_0\,
      S(0) => \leds[3]_INST_0_i_16_n_0\
    );
...
\leds[3]_INST_0_i_9\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \leds[3]_INST_0_i_17_n_0\,
      DI(1) => \leds[3]_INST_0_i_18_n_0\,
      DI(0) => \leds[3]_INST_0_i_19_n_0\,
      O(3 downto 0) => \NLW_leds[3]_INST_0_i_9_O_UNCONNECTED\(3 downto 0),
      S(3) => \leds[3]_INST_0_i_20_n_0\,
      S(2) => \leds[3]_INST_0_i_21_n_0\,
      S(1) => \leds[3]_INST_0_i_22_n_0\,
      S(0) => \leds[3]_INST_0_i_23_n_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
entity bs_distane_leds_HCRS04_0_0 is
  ...
  attribute NotValidForBitStream of bs_distane_leds_HCRS04_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of bs_distane_leds_HCRS04_0_0 : entity is "bs_distane_leds_HCRS04_0_0,HCRS04,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of bs_distane_leds_HCRS04_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of bs_distane_leds_HCRS04_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of bs_distane_leds_HCRS04_0_0 : entity is "HCRS04,Vivado 2022.1";
end bs_distane_leds_HCRS04_0_0;

architecture STRUCTURE of bs_distane_leds_HCRS04_0_0 is
...
begin
U0: entity work.bs_distane_leds_HCRS04_0_0_HCRS04
     port map (
      Trigger => Trigger,
      clk => clk,
      echo => echo,
