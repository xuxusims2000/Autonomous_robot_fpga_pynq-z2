...
##set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { status[0] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=led[2]
##set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { status[1] }]; #IO_L23P_T3_35 Sch=led[3]
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { CLK_OUT }]; #IO_L5P_T0_34 Sch=ar[0]
