...
--Date        : Wed Apr 10 20:59:48 2024
--Host        : DESKTOP-T6T718M running 64-bit major release  (build 9200)
--Command     : generate_target BD_clk.bd
--Design      : BD_clk
...
entity BD_clk is
  ...
  attribute CORE_GENERATION_INFO of BD_clk : entity is "BD_clk,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BD_clk,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of BD_clk : entity is "BD_clk.hwdef";
end BD_clk;

architecture STRUCTURE of BD_clk is
  component BD_clk_processing_system7_0_0 is
  port (
  ...
  end component BD_clk_processing_system7_0_0;
...
begin
  clk50 <= processing_system7_0_FCLK_CLK0;
processing_system7_0: component BD_clk_processing_system7_0_0
     port map (
